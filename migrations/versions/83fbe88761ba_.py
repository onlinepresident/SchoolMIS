...
Revision ID: 83fbe88761ba
Revises: a19c7c4562f0
Create Date: 2020-01-23 00:32:28.346983
...
revision = '83fbe88761ba'
down_revision = 'a19c7c4562f0'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    op.add_column('billing', sa.Column('id', mysql.INTEGER(display_width=11), autoincrement=False, nullable=False))
