...
Revision ID: a19c7c4562f0
Revises: e189f9f5414f
Create Date: 2020-01-23 00:29:13.786973
...
revision = 'a19c7c4562f0'
down_revision = 'e189f9f5414f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.drop_constraint('billing_ibfk_1', 'billing', type_='foreignkey')
    ...
    op.add_column('fee_schedule', sa.Column('id', sa.Integer(), autoincrement=True, nullable=False))
    ...
    op.add_column('fee_schedule_detail', sa.Column('id', sa.Integer(), autoincrement=True, nullable=False))
    ...
    op.add_column('receipt_source', sa.Column('id', sa.Integer(), autoincrement=True, nullable=False))
...
def downgrade():
    ...
    op.drop_constraint(None, 'billing', type_='foreignkey')
    op.drop_constraint(None, 'billing', type_='foreignkey')
    op.create_foreign_key('billing_ibfk_1', 'billing', 'student', ['student_id'], ['Student_id'])
    # ### end Alembic commands ###
