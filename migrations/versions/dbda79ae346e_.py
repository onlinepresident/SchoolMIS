...
Revision ID: dbda79ae346e
Revises: 3d9e31da50c3
Create Date: 2020-01-23 00:11:09.410303
...
revision = 'dbda79ae346e'
down_revision = '3d9e31da50c3'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('billing', sa.Column('student_id', sa.String(length=16), nullable=True))
...
def downgrade():
    ...
    op.drop_constraint(None, 'billing', type_='foreignkey')
    op.drop_constraint(None, 'billing', type_='foreignkey')
    op.drop_column('billing', 'student_id')
    # ### end Alembic commands ###
